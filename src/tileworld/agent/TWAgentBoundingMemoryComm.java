 ...
 * removed.
 */
public class TWAgentBoundingMemoryComm extends TWAgentWorkingMemory {
    /*
     * Bounds of lifetime
    ...
    public TWAgentBoundingMemoryComm(TWAgent moi, Schedule schedule, int x, int y, String agentCommTag) {
