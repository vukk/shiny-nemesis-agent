...
public abstract class TWAgent extends TWEntity implements Steppable {
    ...
    /**
     * This is the heart of your implementation. This is where the agent can use
     * what it has sensed to make a decision. Don't put everything here - you
     * can add some other methods too.
     *
     */
    ...
    protected final void pickUpTile(TWTile tile) {
        ...
        this.getEnvironment().agentPicksUpTile(tile);
    }

    /**
     * Again, do not modify this. Just call this once you're over a hole and
     * want to drop the tile in there
     *
     * @param hole
     */
    protected final void putTileInHole(TWHole hole) {
        ...
        this.getEnvironment().agentPutsTileInHole(hole);
        this.score++;
    }
    ...
    /**
     * This is the procedure executed by the agent at every step of the
     * simulation. It senses, then thinks and then performs its decided action
     *
     * @param state
     */
    ...
    public void setMemory(TWAgentWorkingMemory memory) {
        this.memory = memory;
    }
    public void setCarriedTiles(ArrayList<TWTile> carriedTiles) {
        this.carriedTiles = carriedTiles;
    }
