 ...
 * agents working memory about the observed facts. Each objects that is
 * perceived is stored in the agents memory as a TWAgentMemoryFact : this is
 * just a pair
 * <Object, Time> which indicates the object which was seen and the time at
 * which it was seen. Object is actually a reference to the instance of that
 * TWEntity.
 *
 */
public class TWAgentSensor {
    ...
    public void sense() {
        ...
        me.getEnvironment().getObjectGrid().getNeighborsMaxDistance(me.getX(), me.getY(), sensorRange, false, sensedAgents, agentXCoords, agentYCoords);
