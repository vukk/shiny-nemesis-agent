...
public class TWAgentPercept {
    ...
    private TWEntity o;
    private double t;
    private long obsDiff; // time when this location was observed as different
     ...
     * @return the obsDiff
     */
    public long getObsDiff() {
        return obsDiff;
    }

    /**
     * @param d the obsDiff to set
     */
    public void setObsDiff(long d) {
        this.obsDiff = d;
    }
     ...
     * @param obsDiff time when this location was observed to have something
     * different or empty
     */
    public TWAgentPercept(TWEntity o, double t, long obsDiff) {
        super();
        this.t = t;
        this.o = o;
        this.obsDiff = obsDiff;
    }
