 ...
 * Description:
 *
 * Simple Portrayal based on the rectangle 2d portrayal. This just adds an extra
 * rectangle to display the sensor range of the TWAgent
 *
 */
public class TWAgentPortrayal extends SimplePortrayal2D {
    ...
    public TWAgentPortrayal() {
        this(Color.gray, 1.0, true);
    }

    public TWAgentPortrayal(Paint paint, int sensorRange) {
        this(paint, 1.0, true);
        this.sensorRange = sensorRange;
    }

    public TWAgentPortrayal(double scale) {
        this(Color.gray, scale, true);
    }

    public TWAgentPortrayal(Paint paint, double scale) {
        this(paint, scale, true);
    }

    public TWAgentPortrayal(Paint paint, boolean filled) {
        this(paint, 1.0, filled);
    }

    public TWAgentPortrayal(double scale, boolean filled) {
    ...
    /**
     * If drawing area intersects selected area, add last portrayed object to
     * the bag
     */
    @Override
