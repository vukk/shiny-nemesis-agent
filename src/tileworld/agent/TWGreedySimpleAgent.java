 ...
 *
 */
public class TWGreedySimpleAgent extends TWAgent {

    int threshold = 10;
    private TWEntity target;
    private AstarPathGenerator planner;

    public TWGreedySimpleAgent(int xpos, int ypos, TWEnvironment env, double fuelLevel) {
    ...
    protected TWThought think() {
        ...
        if (this.fuelLevel <= (this.x + this.y) * 1.5 + 10) {
            ...
            System.out.println("Plan to refuel...");
