 ...
 * Description:
 *
 * An Inspector implementation for the TWAgent class. This class implements the
 * controller display which will be displayed when the user clicks on the agent
 * in the GUI.
 *
 * Currently this inspector outputs some information about the agent and adds a
 * button to randomize the agent. This isn't very useful and really for
