 ...
 *
 * The path is a linked list of PathSteps, Each path step is and x,y coordinate
 * and a direction.
 *
 */
public class TWPath {
    ...
    /**
     * Modifys the path with a new path subset, useful when slight modification
     * is needed.
     *
     * @param pathSubSet
     * @param startIndex
    ...
    /**
     * Gets step of plan at specified index, not used and is expensive in linked
     * list Her for completeness.
     *
     * @param index
     * @return
     */
    ...
    /**
     * Returns the direction from startx,starty to goalx, goaly We assume that
     * the two coordinates can only differ in one direction along one dimension.
     * ie., 4 options x++, x--, y++, y--
     *
    ...
    /**
     * Used for executing the path, removes and returns the first step in the
     * plan.
     *
     * @return
     */
