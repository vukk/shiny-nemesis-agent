 ...
 *
 *
 * Description: This is an AStar implementation adopted from elsewhere, the
 * original code and very nice explanation is available here:
 *
 * http://www.cokeandcode.com/pathfinding
 *
 * Note that Tileworld was originally designed to evaluate different planning
 * algorithms. When the environment is highly dynamic producing such long term
 * plans begins to make less sense. Another reactive agent may perform better in
...
public class AstarPathGenerator implements TWPathGenerator {
    ...
    protected class Node implements Comparable {
        ...
        private int depth;
        /**
         * In the original code, visited was part of the map. However, because
         * some implementations may not use path finding (reactive) I think it
         * better to keep it here. Note, this is only used for debugging.
         */
