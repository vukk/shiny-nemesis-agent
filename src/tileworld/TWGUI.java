...
public class TWGUI extends GUIState {
    ...
    /**
     * Portrayal of the main grid which is the environment. Using a standard
    ...
    /**
     * Creates the portrayals for all the relevant objects, including the
     * environment itself. There is a default portrayal for each TWObject which
     * is defined in the appropriate class. Each portrayal describes how the
     * objects appear in the GUI.
     */
    ...
    /**
     * Init is called when the window is initialized You can use this to set up
     * the windows, then register them with the Controller so it can manage
    ...
    public void addMemoryPortrayal(TWAgent agent) {
        ...
        System.out.println("Agent memory size: " + agent.getMemory().getMemorySize());
        ...
        memoryPortrayal.setPortrayalForClass(TWTile.class, TWTile.getMemoryPortrayal());
        memoryPortrayal.setPortrayalForClass(TWObstacle.class, TWObstacle.getMemoryPortrayal());
