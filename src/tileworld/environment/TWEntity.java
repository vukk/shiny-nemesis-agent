 ...
 * Description:
 *
 * Base class from which all entities in the Tileworld inherit. TWObject is a
 * sub-class of this, which is used to specify something with a lifetime (i.e.,
 * Tile, Hole, Obstacle)
 */
...
//        environment.getGrid().set(xpos,ypos,this);
    ...
    /**
     * Returns the manhattan distance from this entity to another specified
     * entity.
     *
